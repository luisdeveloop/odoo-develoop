/* License AGPL-3.0 or later (https://www.gnu.org/licenses/agpl.html). */
   ...
   odoo.define("balance_custom.widget", function (require) {
    "use strict";
    ...
    var MisReportWidget = AbstractField.extend(StandaloneFieldManagerMixin, {
        ...
        events: _.extend({}, AbstractField.prototype.events, {
            ...
            "click #table_custom_drilldown tr.parent": "openChildBlock"
        }),
        ...
        openChildBlock: function(event){
            var itemt = event.currentTarget.classList;
            var child = '.child-' + event.currentTarget.id;
            $('#table_custom_drilldown tr.parent.' + itemt[1]).toggleClass('open');
            $('#table_custom_drilldown tr.parent.' + itemt[1]).nextAll(child).toggleClass('expand');
        },
